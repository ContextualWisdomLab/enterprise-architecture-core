...
BEGIN
  ...
  BEGIN
    INSERT INTO architecture_core.projection_receipt (
        ...
        '0195d145-64e8-7f4f-8a23-a0cc784cb711',
        '0196f410-1111-7111-8111-111111111180',
        'urn:cwl:tenant_001:semantic_data_portal',
        '0196f410-1111-7111-8111-111111111181',
        repeat('c', 64),
        '1.0.0',
    ...
    PERFORM *
      FROM architecture_core.record_data_management_assessment_result(
        '0196f410-1111-7111-8111-111111111180',
        'urn:cwl:tenant_001:data_context:data_management_assessment:0196f410-1111-7111-8111-111111111182',
        ...
        'evidence_complete',
        'observed',
        'urn:cwl:tenant_001:data_context:assessment_evidence:0196f410-1111-7111-8111-111111111183',
        repeat('d', 64),
