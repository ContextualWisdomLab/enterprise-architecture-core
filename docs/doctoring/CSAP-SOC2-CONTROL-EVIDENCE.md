...
| SEC-04 | PR.PS, GV.SC | CC8, CC9 | Change, supplier, dependency, and software supply-chain control | [`.github/workflows/supply-chain.yml`](https://github.com/ContextualWisdomLab/enterprise-architecture-core/blob/ee9d5bcb38507b32c86486dce3480733ab72c4ce/.github/workflows/supply-chain.yml), [release-attestation verifier](https://github.com/ContextualWisdomLab/enterprise-architecture-core/blob/ab8283ed0c51ffea5efebd4803c7a10e2b744f62/scripts/verify_release_attestations.sh), PR34 exact-head local tests and `bash -n` evidence | `candidate` | Hosted terminal Checks, independent same-head review, signed release artifact, and verifier replay remain required. |
