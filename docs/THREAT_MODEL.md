...
3. **Service to PostgreSQL.** `ea_runtime` has no application-table or underlying-projector authority. It receives only the purpose-bound planner read wrapper and target-state approval command wrapper after service-side identity verification.
