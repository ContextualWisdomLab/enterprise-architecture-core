...
- An inferred/proposed target state, authoritative approval, schedule binding, started execution state, completion record, verification outcome, and monitoring decision are distinct states and operations.
