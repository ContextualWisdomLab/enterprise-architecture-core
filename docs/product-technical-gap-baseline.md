...
`040094864b785127a44f7bcb3e5dd8a72d866597`; their exact bases are recorded
...
| ---: | --- | --- | --- | --- |
| [35](https://github.com/ContextualWisdomLab/enterprise-architecture-core/pull/35) | Prepare append-only write boundaries for hot partitioning | `portfolio-assessment-summary` at current base `94b8aa933d602f2a3774c6b2b75b55d3dcdd6fd9` → `hot-write-capacity` | Ready; exact head `040094864b785127a44f7bcb3e5dd8a72d866597`; 697-test/100%-branch-coverage, Ruff, repository, clean PostgreSQL 18 SQL, and runtime privilege evidence pass locally; hosted required Checks are queued; no formal approval | Wait for terminal Checks and an independent same-head review; merge only after PR #33 and its ancestors are current and protected. |
...
| [33](https://github.com/ContextualWisdomLab/enterprise-architecture-core/pull/33) | Publish deterministic portfolio assessment summary | `portfolio-assessment-api` at current base `f8310c1d3bc7525f5bb5c6da0bf9a798ccd35a0d` → `portfolio-assessment-summary` | Ready; exact head `94b8aa933d602f2a3774c6b2b75b55d3dcdd6fd9`; current PR35 aggregate evidence covers the synchronized chain; hosted Checks are queued; no formal approval | Wait for terminal Checks and obtain an independent same-head review; merge only after the synchronized parent and descendant gates are current. |
| [32](https://github.com/ContextualWisdomLab/enterprise-architecture-core/pull/32) | Expose portfolio assessment read port | `data-management-recheck-status-v1` at current base `01f9c0c2ba976f3e4f05d2e8c5263ae14aab77c9` → `portfolio-assessment-api` | Ready; exact head `f8310c1d3bc7525f5bb5c6da0bf9a798ccd35a0d`; current PR35 aggregate evidence covers the synchronized chain; hosted Checks are queued; no formal approval | Wait for terminal Checks and obtain an independent same-head review; repair and revalidate before merge. |
...
| ---: | --- | --- | --- | --- |
| 35 | `040094864b785127a44f7bcb3e5dd8a72d866597` | `2026-08-20T21:13:04Z` | `implementation_candidate` | Local exact-head evidence: 697 tests, 100% statement-and-branch coverage (3250 statements/900 branches), Ruff, repository validation, clean PostgreSQL 18 migrations 0001–0050, every SQL acceptance file, and runtime privilege acceptance pass; hosted Checks queued; no formal approval. |
...
| 33 | `94b8aa933d602f2a3774c6b2b75b55d3dcdd6fd9` | `2026-08-20T21:13:04Z` | `implementation_candidate` | Synchronized parent of PR35; current PR35 aggregate local evidence covers this exact chain; hosted Checks queued; no formal approval. |
| 32 | `f8310c1d3bc7525f5bb5c6da0bf9a798ccd35a0d` | `2026-08-20T21:13:04Z` | `implementation_candidate` | Synchronized parent of PR33; current PR35 aggregate local evidence covers this exact chain; hosted Checks queued; no formal approval. |
