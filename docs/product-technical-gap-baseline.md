...
**Live refresh:** `2026-08-21T01:08:46Z` — PR #16 was inspected at exact head
...
`97f58751be58ab28fe34bf7d22a089f2ef45831c`, based on protected
...
| [18](https://github.com/ContextualWisdomLab/enterprise-architecture-core/pull/18) | Buyer README and architecture decision records | `develop` at current base `1c0fa8b15ceb9e72186274aeb255d6777eb84ef4` → `cursor/ea-core-customer-docs-609e` | Ready; exact head `97f58751be58ab28fe34bf7d22a089f2ef45831c`; evidence baseline includes the current PR16, scheduler, PR34, and PR35 updates; hosted Checks are queued; no formal approval | Obtain an independent same-head review, diagnose only current-head failures, and re-fetch all terminal Checks before merge. |
...
| 18 | `97f58751be58ab28fe34bf7d22a089f2ef45831c` | `2026-08-21T01:08:46Z` | `implementation_candidate` | Documentation snapshot source head; evidence baseline includes the current PR16, scheduler, PR34, and PR35 updates; hosted Checks queued; no formal current-head approval observed. |
