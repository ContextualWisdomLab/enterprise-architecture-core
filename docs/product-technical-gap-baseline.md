...
Checks are queued and PR #26 is Ready. PR #33 is current at
...
Checks are queued and it is Ready. No formal same-head approval or protected
merge is observed.
...
| ---: | --- | --- | --- | --- |
| [36](https://github.com/ContextualWisdomLab/enterprise-architecture-core/pull/36) | Add repeatable hot-write capacity snapshot | `hot-write-capacity` at current base `75c1f6d8e46bcd4ceb62dd3747658240da5c88fc` → `codex/hot-write-capacity-report` | Ready; exact head `5f33c1375b0e62f5724627f5de4b02fe9cbc3037`; current stack passes 705 Python tests with 100% statement-and-branch coverage, Ruff, actionlint, repository validation, and `uv lock --check`; prior stack PostgreSQL evidence is historical and fresh current-head runtime/database evidence remains pending; hosted Checks are queued; no formal approval | Obtain an independent same-head review and terminal Checks; merge only after the exact current stack is valid. |
| [35](https://github.com/ContextualWisdomLab/enterprise-architecture-core/pull/35) | Prepare append-only write boundaries for hot partitioning | `portfolio-assessment-summary` at current base `5899a407728c52baa0477f1158b676e0e5c01f74` → `hot-write-capacity` | Ready; exact head `75c1f6d8e46bcd4ceb62dd3747658240da5c88fc`; current parent propagation retains the scoped inferred-dimension assertion and the stack’s 705-test/100%-coverage, Ruff, and repository evidence; hosted Checks are queued; no formal approval | Obtain terminal Checks and an independent same-head review; merge only after the exact current stack is valid. |
| [34](https://github.com/ContextualWisdomLab/enterprise-architecture-core/pull/34) | Repair protected-main SPDX attestation compatibility | `main` at current base `ca6889497728e1a3f09d68790a9096576e13a3ff` → `codex/supply-chain-sbom-attestation` | Ready; exact head `1c6db352822c493eb248fec8f4eebcb67f948a20`; verifier binds the signed SPDX predicate to the downloaded SBOM snapshot and rejects reused/symlinked verification output; 137 tests, 100% statement/branch coverage, Ruff, and `bash -n` pass locally; hosted Checks are queued; no formal approval | Obtain terminal hosted Checks and an independent same-head review before merge. |
| [33](https://github.com/ContextualWisdomLab/enterprise-architecture-core/pull/33) | Publish deterministic portfolio assessment summary | `portfolio-assessment-api` at current base `de0f14a82e78c564df80337e687984bea8bab04a` → `portfolio-assessment-summary` | Ready; exact head `5899a407728c52baa0477f1158b676e0e5c01f74`; portfolio contract count remains 14 operations, the inferred fixture assertion is dimension-scoped, and 705 local Python tests pass with 100% coverage plus current parent checks; hosted Checks are queued; no formal approval | Obtain terminal Checks and an independent same-head review. |
| [32](https://github.com/ContextualWisdomLab/enterprise-architecture-core/pull/32) | Expose portfolio assessment read port | `data-management-recheck-status-v1` at base `e230c9b3a1c49b5fad41c96a6c315602c25c8da5` → `portfolio-assessment-api` | Ready; exact head `de0f14a82e78c564df80337e687984bea8bab04a`; current parent propagation preserves the PR31 status fixes, dimension-scoped portfolio acceptance, 684 tests with 100% coverage, Ruff, repository validation, and lock validation; hosted Checks are queued; no formal approval | Obtain terminal Checks and an independent same-head review. |
| [31](https://github.com/ContextualWisdomLab/enterprise-architecture-core/pull/31) | Expose data-management reassessment status | `data-management-recheck-v1` at current base `8b925a9c04c0b15ca4282c1859bb49b04bd381c6` → `data-management-recheck-status-v1` | Ready; exact head `e230c9b3a1c49b5fad41c96a6c315602c25c8da5`; 651 tests with 100% statement-and-branch coverage, Ruff, repository validation, and lock validation pass after the fixture/validator repair; hosted Checks are queued; no formal approval | Obtain terminal Checks and an independent same-head review before advancing the stack. |
| [30](https://github.com/ContextualWisdomLab/enterprise-architecture-core/pull/30) | Request data-management assessment recheck | `data-management-evidence-closure-v1` at current base `51246466647c84f7e9accffb0b06ccc1fcef0fd8` → `data-management-recheck-v1` | Ready; exact head `8b925a9c04c0b15ca4282c1859bb49b04bd381c6`; 616 tests with 100% coverage, repository validation, actionlint, and `uv lock --check` pass after parent propagation; prior clean PostgreSQL evidence remains historical; hosted Checks are queued; no formal approval | Obtain terminal hosted Checks and an independent same-head review before advancing the stack. |
| [29](https://github.com/ContextualWisdomLab/enterprise-architecture-core/pull/29) | Accept data-management evidence and complete milestone | `data-management-improvement-v1` at current base `350b8b4451a5c39ab35d9e6ca7c2b65f9e3dd4df` → `data-management-evidence-closure-v1` | Ready; exact head `51246466647c84f7e9accffb0b06ccc1fcef0fd8`; 581 tests, 100% statement/branch coverage, Ruff, repository validation, actionlint, and `uv lock --check` are green after parent propagation; hosted Checks are queued and no formal approval is observed. | Obtain terminal hosted Checks and an independent same-head review before advancing the milestone. |
| [27](https://github.com/ContextualWisdomLab/enterprise-architecture-core/pull/27) | Turn data-management gaps into improvement work | `target-state-replan-v1` at current base `f8ef89532ca61318a29199ae56a6bfe51ecdfc49` → `data-management-improvement-v1` | Ready; exact head `350b8b4451a5c39ab35d9e6ca7c2b65f9e3dd4df`; local 544 tests with 100% statement-and-branch coverage, Ruff, actionlint, repository validation, and diff validation pass after the PR26 terminal-test repair; hosted Checks are newly queued and no formal approval | Obtain independent same-head review and terminal current-head gates while preserving foreign-system ownership. |
| [26](https://github.com/ContextualWisdomLab/enterprise-architecture-core/pull/26) | Make target-state replanning executable | `target-state-monitoring-v1` → `target-state-replan-v1` | Ready; exact head `f8ef89532ca61318a29199ae56a6bfe51ecdfc49`; 533 Python tests with 100% statement-and-branch coverage, Ruff, actionlint, repository validation, and diff validation pass after transaction-isolating the planner fixture, workflow credential repair, and terminal-test fixture isolation; hosted Checks are queued; no formal approval | Obtain an independent same-head review and terminal Checks, then verify `gap_detected` semantics and exact replay behavior. |
