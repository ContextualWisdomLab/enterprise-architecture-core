...
**Snapshot:** 2026-08-20T14:02:38Z, GitHub API and repository inspection<br>
...
**Live refresh:** `2026-08-20T14:02:38Z` — PR #18 is currently at exact head
`58c78fb6e18aae2a3b0724c6106653c5293b8d19` with no formal review and hosted
required checks pending. All previously draft stacked PRs were marked ready
for review at their existing exact heads. PR #35 is the new hot-write-capacity candidate at
exact head `57ad0f36f54ecfdbfd800a766dd6992261f62215`, based on PR #33 exact
head `940e89415fbafa5d6da76f114da273de7439da17`; its required checks are
...
| ---: | --- | --- | --- | --- |
| [35](https://github.com/ContextualWisdomLab/enterprise-architecture-core/pull/35) | Prepare append-only write boundaries for hot partitioning | `portfolio-assessment-summary` at current base `940e89415fbafa5d6da76f114da273de7439da17` → `hot-write-capacity` | Ready; exact head `57ad0f36f54ecfdbfd800a766dd6992261f62215`; parent fixture fixes are included through the current base; hosted required Checks are pending; fresh exact-head review dispatch awaits API rate-limit recovery | Wait for terminal Checks and an independent same-head review; merge only after PR #33 and its ancestors are current and protected. |
...
| [33](https://github.com/ContextualWisdomLab/enterprise-architecture-core/pull/33) | Publish deterministic portfolio assessment summary | `portfolio-assessment-api` at current base `03fd6269e87d0eee5e9a9d312cffe390398df339` → `portfolio-assessment-summary` | Ready; exact head `940e89415fbafa5d6da76f114da273de7439da17`; portfolio acceptance fixture isolation is fixed at the introducing parent; hosted Checks and a fresh exact-head review are pending | Wait for terminal Checks and obtain an independent same-head review; merge only after the synchronized parent and descendant gates are current. |
...
| [31](https://github.com/ContextualWisdomLab/enterprise-architecture-core/pull/31) | Expose data-management reassessment status | `data-management-recheck-v1` → `data-management-recheck-status-v1` | Ready; newest workflow runs queued; exact-head OpenCode review dispatched | Wait for terminal Checks, inspect review, then repair and revalidate the exact head. |
...
| [18](https://github.com/ContextualWisdomLab/enterprise-architecture-core/pull/18) | Buyer README and architecture decision records | `develop` → `cursor/ea-core-customer-docs-609e` | Ready; exact head `58c78fb6e18aae2a3b0724c6106653c5293b8d19`; no formal review; hosted required-workflow and security/provenance evidence remains queued | Obtain an independent same-head review, diagnose only current-head failures, and re-fetch all terminal Checks before merge. |
...
refreshed at `2026-08-20T13:47:06Z`. Every open PR is classified as
...
| ---: | --- | --- | --- | --- |
| 35 | `57ad0f36f54ecfdbfd800a766dd6992261f62215` | `2026-08-20T14:02:38Z` | `implementation_candidate` | PostgreSQL 18 clean-install and 0049→0050 upgrade acceptance passed locally after version-stable MD5 bucket mapping; Python 682-test/100% coverage, Ruff, and repository validation passed; hosted Checks pending; parent fixture fixes are in the exact base. |
...
| 33 | `940e89415fbafa5d6da76f114da273de7439da17` | `2026-08-20T14:02:38Z` | `implementation_candidate` | Parent acceptance fixture isolation has been repaired; hosted Checks and fresh exact-head review are pending. |
...
| 31 | `6ab5cf065c2042b6a4fab4231607d2a1a3b9a729` | `2026-08-20T13:06:28Z` | `implementation_candidate` | Open draft candidate; no protected integration, immutable release, or live deployment evidence observed. |
...
| 18 | `58c78fb6e18aae2a3b0724c6106653c5293b8d19` | `2026-08-20T13:58:29Z` | `implementation_candidate` | Documentation snapshot refresh is pushed; hosted required workflows/security/provenance Checks pending; no formal current-head review. |
