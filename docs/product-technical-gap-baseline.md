...
| [18](https://github.com/ContextualWisdomLab/enterprise-architecture-core/pull/18) | Buyer README and architecture decision records | `develop` at current base `1c0fa8b15ceb9e72186274aeb255d6777eb84ef4` → `cursor/ea-core-customer-docs-609e` | Ready; documentation refresh based on source parent `f8196a0653a7d22d806d9cd2f62c19b36bb99021`; evidence baseline includes the current PR16, scheduler, PR34, PR35, PR36, and target-state fixture repairs; hosted Checks are queued; no formal approval | Obtain an independent same-head review, diagnose only current-head failures, and re-fetch all terminal Checks before merge. |
...
| 18 | `f8196a0653a7d22d806d9cd2f62c19b36bb99021` | `2026-08-21T01:27:22Z` | `implementation_candidate` | Documentation snapshot source parent; evidence baseline includes the current PR16, scheduler, PR34, PR35, PR36, and target-state fixture repairs; hosted Checks queued; no formal current-head approval observed. |
