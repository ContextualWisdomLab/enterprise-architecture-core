...
The current TOGAF Standard is **The TOGAF® Standard, 10th Edition** (document C220), a standard of The Open Group. The official catalog records Technical Corrigendum 1 applied in May 2025 and lists the edition as adopted, US ISBN 1-947754-90-4, published 19 May 2025 (The Open Group, 2025a, 2025b). The standard is divided into TOGAF Fundamental Content and TOGAF Series Guides. Fundamental Content includes Introduction and Core Concepts, the Architecture Development Method (ADM), ADM Techniques, Applying the ADM, Architecture Content, and Enterprise Architecture Capability and Governance. Series Guides listed on the same official catalog include Business Capabilities, Version 2; Business Capability Planning; Digital Technology Adoption: A Guide to Readiness Assessment and Roadmap Development; and Microservices Architecture (MSA) (The Open Group, 2025a).
...
Official Open Group catalog and library URLs are the citation path. Hosts consume the resulting decision records through contracts published by this repository.
...
- Operators evaluate this plane against the official TOGAF Standard URLs below, not against unofficial summaries.

## References

The Open Group. (2025a). *The TOGAF® Standard, 10th Edition* (C220). https://publications.opengroup.org/c220

The Open Group. (2025b). *The TOGAF® Standard, 10th Edition* (C220). https://www.opengroup.org/library/c220

The Open Group. (n.d.-a). *The TOGAF® Standard, a standard of The Open Group*. https://publications.opengroup.org/standards/togaf

The Open Group. (n.d.-b). *TOGAF® Standard, 10th Edition downloads*. https://www.opengroup.org/togaf-standard-10th-edition-downloads

The Open Group. (n.d.-c). *What is new in the TOGAF® Standard, 10th Edition?* https://www.opengroup.org/togaf/new-version
