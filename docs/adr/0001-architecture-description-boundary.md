...
The final standard is **ISO/IEC/IEEE 42010:2022**, *Software, systems and enterprise — Architecture description*, published 7 November 2022, DOI [10.1109/IEEESTD.2022.9938446](https://doi.org/10.1109/IEEESTD.2022.9938446). IEEE SA records the same edition as IEEE/ISO/IEC 42010-2022, board-approved 21 September 2022, superseding 42010-2011. The 2020 draft is not the final standard and is not cited here. Alternate official locators are in [docs/REFERENCES.md](../REFERENCES.md).
